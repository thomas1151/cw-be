...
('FileCompiler__0d742f7d56a2c6ba1d61278aca453074', '{"source":{"file":"\\/opt\\/lampp\\/htdocs\\/mats\\/public_html\\/site\\/templates\\/api-get-element.php","hash":"3e0344cf3a0ed1535c7b960b8c6b08c3","size":425,"time":1535473074,"ns":"ProcessWire"},"target":{"file":"\\/opt\\/lampp\\/htdocs\\/mats\\/public_html\\/site\\/assets\\/cache\\/FileCompiler\\/site\\/templates\\/api-get-element.php","hash":"3e0344cf3a0ed1535c7b960b8c6b08c3","size":425,"time":1535473074}}', '2010-04-08 03:10:10'),
...
(107, 'api-get-element'),
(108, 'api-get-scale'),
(109, 'api-post-generic'),
(110, 'tag-section'),
(111, 'tag'),
(112, 'categories-section'),
(113, 'category');
...
(100, 'FieldtypePage', 'linked_category', 0, '', '{"derefAsPage":1,"inputfield":"InputfieldSelect","parent_id":0,"labelFieldName":"title","collapsed":0}'),
(101, 'FieldtypePage', 'linked_tags', 0, '', '{"derefAsPage":0,"inputfield":"InputfieldAsmSelect","parent_id":1049,"labelFieldName":"title","collapsed":0,"template_id":57,"addable":1,"usePageEdit":0}');
...
--
-- Table structure for table `field_linked_category`
--

CREATE TABLE `field_linked_category` (
  `pages_id` int(10) UNSIGNED NOT NULL,
  `data` int(11) NOT NULL,
  `sort` int(10) UNSIGNED NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `field_linked_tags`
--

CREATE TABLE `field_linked_tags` (
  `pages_id` int(10) UNSIGNED NOT NULL,
  `data` int(11) NOT NULL,
  `sort` int(10) UNSIGNED NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `field_linked_tags`
--

INSERT INTO `field_linked_tags` (`pages_id`, `data`, `sort`) VALUES
(1015, 1051, 0),
(1015, 1052, 1),
(1015, 1053, 2);
...
(1015, 1014, 44, 'who-is', 1, '2018-09-03 09:53:07', 41, '2018-04-12 16:13:46', 41, '2018-04-12 17:13:55', 0),
...
(1035, 1044, 51, 'scales', 1, '2018-08-28 16:07:43', 41, '2018-04-13 08:57:00', 41, '2018-04-13 09:57:00', 2),
...
(1043, 1033, 52, 'post', 1, '2018-04-26 10:12:53', 41, '2018-04-26 10:12:53', 41, '2018-04-26 11:12:53', 1),
(1044, 1033, 52, 'get', 1, '2018-08-28 16:07:14', 41, '2018-08-28 16:07:09', 41, '2018-08-28 17:07:09', 3),
(1045, 1044, 53, 'element', 1, '2018-08-28 16:14:52', 41, '2018-08-28 16:10:26', 41, '2018-08-28 17:10:26', 2),
(1046, 1044, 54, 'scale', 1, '2018-08-28 16:20:14', 41, '2018-08-28 16:18:44', 41, '2018-08-28 17:18:44', 3),
(1047, 1043, 55, 'element', 1, '2018-09-03 06:27:10', 41, '2018-09-03 06:27:10', 41, '2018-09-03 07:27:10', 0),
(1048, 1043, 55, 'scale', 1, '2018-09-03 06:28:20', 41, '2018-09-03 06:28:20', 41, '2018-09-03 07:28:20', 1),
(1049, 1, 56, 'tags', 1, '2018-09-03 09:28:34', 41, '2018-09-03 09:28:12', 41, '2018-09-03 10:28:29', 10),
(1050, 1, 58, 'categories', 1, '2018-09-03 09:39:27', 41, '2018-09-03 09:39:27', 41, '2018-09-03 10:39:27', 11),
(1051, 1049, 57, 'about', 1, '2018-09-03 09:53:07', 41, '2018-09-03 09:53:07', 41, '2018-09-03 10:53:07', 0),
(1052, 1049, 57, 'people', 1, '2018-09-03 09:53:07', 41, '2018-09-03 09:53:07', 41, '2018-09-03 10:53:07', 1),
(1053, 1049, 57, 'question', 1, '2018-09-03 09:53:07', 41, '2018-09-03 09:53:07', 41, '2018-09-03 10:53:07', 2);
...
(1044, 1, '2018-08-28 16:07:09'),
(1035, 1, '2018-08-28 16:07:43'),
(1034, 1, '2018-08-28 16:08:09'),
(1045, 1, '2018-08-28 16:10:26'),
(1046, 1, '2018-08-28 16:18:44'),
(1047, 1, '2018-09-03 06:27:10'),
(1048, 1, '2018-09-03 06:28:20'),
(1049, 1, '2018-09-03 09:28:12'),
(1050, 1, '2018-09-03 09:39:27'),
(1051, 1, '2018-09-03 09:53:07'),
(1052, 1, '2018-09-03 09:53:07'),
(1053, 1, '2018-09-03 09:53:07');
...
(50, 'api-elements', 104, 0, 0, '{"slashUrls":1,"compile":3,"modified":1535746033,"noAppendTemplateFile":1,"appendFile":"_ajax_main.php","ns":"ProcessWire"}'),
(51, 'api-scales', 105, 0, 0, '{"slashUrls":1,"compile":3,"modified":1535746033,"noAppendTemplateFile":1,"appendFile":"_ajax_main.php","ns":"ProcessWire"}'),
(52, 'post', 106, 0, 0, '{"slashUrls":1,"compile":3,"modified":1524737552}'),
(53, 'api-get-element', 107, 0, 0, '{"slashUrls":1,"compile":3,"modified":1535957376,"noAppendTemplateFile":1,"appendFile":"_ajax_main.php","ns":"ProcessWire"}'),
(54, 'api-get-scale', 108, 0, 0, '{"slashUrls":1,"compile":3,"modified":1535957404,"noAppendTemplateFile":1,"appendFile":"_ajax_main.php","contentType":"json","ns":"ProcessWire"}'),
(55, 'api-post-generic', 109, 0, 0, '{"slashUrls":1,"compile":3,"modified":1535965099,"ns":"ProcessWire"}'),
(56, 'tag-section', 110, 0, 0, '{"noParents":-1,"childTemplates":[57],"slashUrls":1,"compile":3,"modified":1535967659}'),
(57, 'tag', 111, 0, 0, '{"noChildren":1,"parentTemplates":[56],"slashUrls":1,"compile":3,"modified":1535967463}'),
(58, 'categories-section', 112, 0, 0, '{"childTemplates":[59],"slashUrls":1,"compile":3,"modified":1535967430}'),
(59, 'category', 113, 0, 0, '{"noChildren":1,"parentTemplates":[58],"slashUrls":1,"compile":3,"modified":1535967353}');
...
--
-- Indexes for table `field_linked_category`
--
ALTER TABLE `field_linked_category`
  ADD PRIMARY KEY (`pages_id`,`sort`),
  ADD KEY `data` (`data`,`pages_id`,`sort`);

--
-- Indexes for table `field_linked_tags`
--
ALTER TABLE `field_linked_tags`
  ADD PRIMARY KEY (`pages_id`,`sort`),
  ADD KEY `data` (`data`,`pages_id`,`sort`);
